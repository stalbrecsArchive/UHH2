...
inputDatasets = [ #'/JetHT/Run2016B-17Jul2018_ver1-v1/MINIAOD',
...
config = config()
config.General.workArea = 'dump/crab_Test'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = os.path.join(os.environ['CMSSW_BASE'], 'src/UHH2/core/python/ntuplewriter_data_2016v3.py')
