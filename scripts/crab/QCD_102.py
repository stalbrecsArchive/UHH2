...
inputDatasets = [
    # '/RelValQCD_FlatPt_15_3000HS_13_UP18/CMSSW_10_6_4_patch1-PU25ns_106X_upgrade2018_realistic_v9_HS_resub-v1/MINIAODSIM'
    '/QCD_Pt-15to7000_TuneCP5_Flat_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext1-v1/MINIAODSIM'
]
...
config = config()
config.General.workArea = 'UL18_crab'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = os.path.join(os.environ['CMSSW_BASE'], 'src/UHH2/core/python/ntuplewriter_mc_2018_allConstits.py')
...
config.Data.totalUnits = config.Data.unitsPerJob * 50
...
try:
    ...
    year = result.group()
    config.Data.outLFNDirBase = '/store/user/%s/RunII_102X_UL18/%s/' % (getUsernameFromSiteDB(), year)
